...
const lat = qS(".lat");
const lon = qS(".lon");
const nameCity = qS(".name");
const temperatura = qS(".temperatura");
const temperMin = qS(".temp-min");
const temperMax = qS(".temp-max");
const tempUmidità = qS(".tempHumidity");
const descWeather = qS(".weather");
const descWind = qS(".wind");
const selectProvince = qS(".sel_city");
const iconTempo = qS(".icon");
